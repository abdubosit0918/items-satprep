...
CHANNEL_JOIN_URL = get_channel_join_url(CHANNEL_USERNAME)
...
def materials_unlocked_text() -> str:
    return (
        ...
        "You got:\n"
        "• <b>50 IELTS Reading & Listening materials</b>\n"
...
async def capture_start_payload(message: Message) -> None:
    ...
    referrer_id = parse_referrer_id(args)
